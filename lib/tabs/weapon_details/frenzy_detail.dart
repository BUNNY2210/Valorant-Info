            ...
            children: <Widget>[
              ...
              Card(
                ...
                child: Column(
                  mainAxisSize: MainAxisSize.min,
                  children: <Widget>[
                    Image.asset('img/frenzy.png', height: 300, width: 500),
                  ],
                ),
              ),
            ],
...
class FrenzyFire extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return WebviewScaffold(
      ...
      url:
          "https://blitz-cdn-videos.blitz.gg/valorant/weapons/frenzy/spray_footage/frenzy_primary2.mp4",
    );
  }
}
